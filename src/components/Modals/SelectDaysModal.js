...
const availableDays = [
        { day: 'Lunes', hours: ['08:00', '09:00', '16:00', '17:00', '18:00', '19:00', '20:00'] },
    ...
    export default function SelectDaysModal({ isOpen, onClose, diasSemanales, existingSelections, cambiosRestantes, onUpdate }) {
                                    ...
                                    <Box 
                                        ...
                                        {hours.map((hour) => {
                                            ...
                                            <Checkbox
                                                ...
                                                bg={selectedKeys.has(key) ? 'teal.500' : 'white'}
                                                color={selectedKeys.has(key) ? 'white' : 'brand.primary'}
                                                fontWeight="medium"
                                                _hover={{ bg: selectedKeys.has(key) ? 'teal.600' : 'gray.100' }}
